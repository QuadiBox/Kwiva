...
export default function EditStoryPage({ cId }) {
    ...
    const updateSummaryInStorylist = async () => {
        if (!formData?.summaryDocId || !formData?.contentId) {
            console.warn(
                "Missing summaryDocId or contentId. Skipping storylist update."
            );
            return;
        }

        const summaryRef = doc(db, "storylist", formData.summaryDocId);
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            await updateSummaryInStorylist();
