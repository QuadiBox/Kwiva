...
const GSTClientComponent = () => {
    ...
    const handleQuestionPrep = async () => {
        ...
        //get "arts" from localStorage
        //if not available or it's expiryTime value hass been exceeded, fetch all document that's not _meta from arts collection on firestore
        //flatten questions array from arts collection documents to get a giant array of objects and update the localStorage arts by seting the giant array as the questions field and expiryTime set to 3 days from Date.now() 
        ...
        setLoading(true);
        window.location.href = `/quizzez/arts/1`;
    }
    ...
    return (
        <>
            ...
            <div className="ad_slot">
                <GoogleAd key={`ad-qz-arts-start`} adKey={`ad-qz-arts-start`}></GoogleAd>
            </div>
