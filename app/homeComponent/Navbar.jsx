...
const Navbar = () => {
    ...
    const handleLinking = (vlad) => {        
        window.location.href = vlad;
    }
    ...
    return (
        <div className={`sticky-bar ${openMenu ? 'opened' : "closed"}`}>
            ...
            <div className="mobileDisplay">
                ...
                <span href={"/blogs"} role='link' onClick={() => {handleLinking("/blogs")}} className="unitNavLink _hh" data-label="Blogs">
                    <i className="icofont-paper"></i>
                    <span>Blogs</span>
                </span>
                <span href={"/quizzez"} role='link' onClick={() => {handleLinking("/quizzez")}} className="unitNavLink _hhh" data-label="Quizzez">
                    <i className="icofont-electron"></i>
                    <span>Quizzez</span>
                </span>
                <span href={"/invite"} role='link' onClick={() => {handleLinking("/invite")}} className="unitNavLink _hhhh" data-label="Invite">
